...
<body>
  ...
  <!--           <div class="u-avatar mx-auto mb-4">
          ...
          <div class="col-lg-6 position-relative">
            ...
            <div class="row mx-gutters-2">
              ...
              <div class="col-5 offset-1 px-2 mb-3">
                <!-- Fancybox -->
                <a class="js-fancybox u-media-viewer" href="javascript:;"
                   data-src="{{ asset("pron/img/buku/buku_new.jpg")}}"
                   data-fancybox="lightbox-gallery-hidden"
                   data-caption="Front in frames - image #03"
                   data-speed="700">
                  <img class="img-fluid rounded" src="{{ asset("pron/img/buku/buku_new.jpg")}}" alt="Image Description">
              ...
              <div class="col-5 px-2 mb-3">
                <!-- Fancybox -->
                <a class="js-fancybox u-media-viewer" href="javascript:;"
                   data-src="{{ asset("pron/img/buku/buku_10.jpeg")}}"
                   data-fancybox="lightbox-gallery-hidden"
                   data-caption="Front in frames - image #04"
                   data-speed="700">
                  <img class="img-fluid rounded" src="{{ asset("pron/img/buku/buku_10.jpeg")}}" alt="Image Description">
              ...
              <div class="mb-7">
                ...
                <p>
                  <ul>
                    ...
                    <li><b>Prof. Dr. Wahyudi Siswanto, M.Pd</b> <br/>(Penulis 54 Buku, Dosen, Pengusaha)</li>
                    <li><b>Ir. H. Jonih Rahmat, S.H.I.</b> <br/>(Trainer & Penulis 6 Buku Best Seller)</li>
                    <li><b>David MinG</b> <br/>(Profesional Ghost Writer, Penerbit)</li>
                  </ul>
                </p>
              </div>
              <!-- End Title -->
          ...
          <div class="col-lg-6 position-relative">
            ...
            <div class="row mx-gutters-2">
              ...
              <div class="col-5 offset-1 px-2 mb-3">
                <!-- Fancybox -->
                <a class="js-fancybox u-media-viewer" href="javascript:;"
                   data-src="{{ asset("pron/img/pemateri/pemateri-05.png")}}"
                   data-fancybox="lightbox-gallery-hidden"
                   data-caption="Front in frames - image #03"
                   data-speed="700">
                  <img class="img-fluid rounded" src="{{ asset("pron/img/pemateri/pemateri-05.png")}}" alt="Image Description">
    ...
    <div class="container space-top-2 space-top-md-2 text-center" id="daftar_section">
      ...
      <img style="width: 90%;" src="{{ asset("pron/img/brosur_menulis_2.jpg")}}">
      <br/>
      <br/>
