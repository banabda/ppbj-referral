                      ...
                      <div class="elementor-widget-container mb-3">
                        ...
                        <div class="col-md-9 offset-md-2 text-left">
                          <ul class="mb-3" style="list-style-type: square;font-size:20px;color: #000;">
                            ...
                            <li><b>Penghitungan Bonus</b> : Peserta Anda yang telah melakukan Pembayaran <b style="color:red">x Rp. 75.000.</b></li>
                            <li><b>Ilustrasi</b> : Peserta yang mendaftar melalui <b>Link Affilitae anda</b> sebanyak <b>200 orang</b>, dan 200 orang <b>telah menyelesaikan Pembayaran</b>, maka Bonus Anda adalah <b style="color:red">200 x Rp. 75.000 = Rp. 15.000.000,-</b></li>
                      ...
                      <div class="elementor-widget-wrap">
                        ...
                        <div
                          ...
                          <div class="elementor-widget-container">
                            <div class="row">
                                <div class="col-md-5">
                                    <img width="905" height="1280" src="{{ asset("pron/img/brosur_hypno_4.jpg") }}" alt="" loading="lazy">
...
*Link Regestrasi* {{ route('landing') }}?ref={{ $user['ref'] }}
